...
class MetaTransactionError extends react_1.default.PureComponent {
    render() {
        ...
        const chainId = eth_1.getChainIdByNetwork(schemas_1.Network.MATIC);
        const network = schemas_1.getChainName(chainId);
        return (react_1.default.createElement("div", null,
            react_1.default.createElement(uikit_1.Row, null, text),
            react_1.default.createElement("br", null),
            react_1.default.createElement(uikit_1.Row, { align: "right" },
                react_1.default.createElement(uikit_1.Button, { basic: true, onClick: () => onSwitchNetwork(chainId) }, utils_1.t('@dapps.toasts.switch_network', { network })),
                "\u00A0",
                learnMoreLink ? (react_1.default.createElement(uikit_1.Button, { basic: true, href: learnMoreLink, target: "_blank", rel: "noopener noreferrer" }, utils_1.t('@dapps.toasts.learn_more'))) : null)));
    }
}
