...
const fetchTransactionRequest = (address, hash, actionObject) => (0, typesafe_actions_1.action)(exports.FETCH_TRANSACTION_REQUEST, {
    address,
    hash,
    action: actionObject
});
exports.fetchTransactionRequest = fetchTransactionRequest;
const fetchTransactionSuccess = (transaction) => (0, typesafe_actions_1.action)(exports.FETCH_TRANSACTION_SUCCESS, { transaction });
exports.fetchTransactionSuccess = fetchTransactionSuccess;
const fetchTransactionFailure = (hash, status, message, transaction) => (0, typesafe_actions_1.action)(exports.FETCH_TRANSACTION_FAILURE, {
    hash,
    status,
    message,
    transaction
...
const watchPendingTransactions = () => (0, typesafe_actions_1.action)(exports.WATCH_PENDING_TRANSACTIONS, {});
...
const updateTransactionStatus = (hash, status) => (0, typesafe_actions_1.action)(exports.UPDATE_TRANSACTION_STATUS, { hash, status });
exports.updateTransactionStatus = updateTransactionStatus;
// Update transaction nonce
exports.UPDATE_TRANSACTION_NONCE = 'Update Transaction Nonce';
const updateTransactionNonce = (hash, nonce) => (0, typesafe_actions_1.action)(exports.UPDATE_TRANSACTION_NONCE, { hash, nonce });
...
const watchDroppedTransactions = () => (0, typesafe_actions_1.action)(exports.WATCH_DROPPED_TRANSACTIONS, {});
...
const watchRevertedTransaction = (hash) => (0, typesafe_actions_1.action)(exports.WATCH_REVERTED_TRANSACTION, { hash });
...
const fixRevertedTransaction = (hash) => (0, typesafe_actions_1.action)(exports.FIX_REVERTED_TRANSACTION, { hash });
...
const replaceTransactionRequest = (hash, nonce) => (0, typesafe_actions_1.action)(exports.REPLACE_TRANSACTION_REQUEST, {
    hash,
    nonce
});
exports.replaceTransactionRequest = replaceTransactionRequest;
const replaceTransactionSuccess = (hash, replaceBy) => (0, typesafe_actions_1.action)(exports.REPLACE_TRANSACTION_SUCCESS, { hash, replaceBy });
exports.replaceTransactionSuccess = replaceTransactionSuccess;
const replaceTransactionFailure = (hash, error) => (0, typesafe_actions_1.action)(exports.REPLACE_TRANSACTION_FAILURE, {
    hash,
    error
});
...
const clearTransactions = (address, clearPendings = false) => (0, typesafe_actions_1.action)(exports.CLEAR_TRANSACTIONS, {
    address,
    clearPendings
});
...
const clearTransaction = (hash) => (0, typesafe_actions_1.action)(exports.CLEAR_TRANSACTION, {
    hash
});
