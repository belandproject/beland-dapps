...
function walletReducer(state = exports.INITIAL_STATE, action) {
    switch (action.type) {
        ...
        case actions_1.CONNECT_WALLET_SUCCESS: {
            return Object.assign(Object.assign({}, state), { loading: (0, reducer_1.loadingReducer)(state.loading, action), error: null, data: action.payload.wallet });
        }
        ...
        case actions_1.ENABLE_WALLET_SUCCESS: {
            return Object.assign(Object.assign({}, state), { loading: (0, reducer_1.loadingReducer)(state.loading, action), error: null, hasAcceptedNetworkPartialSupport: false });
        }
        ...
        case actions_1.SET_APP_CHAIN_ID: {
            return Object.assign(Object.assign({}, state), { appChainId: action.payload.chainId });
        }
        default:
            return state;
    }
