...
const showToast = (toast) => (0, typesafe_actions_1.action)(exports.SHOW_TOAST, { toast });
exports.showToast = showToast;
// Render Toast
exports.RENDER_TOAST = 'Render toast';
const renderToast = (id) => (0, typesafe_actions_1.action)(exports.RENDER_TOAST, { id });
exports.renderToast = renderToast;
// Hide Toast
exports.HIDE_TOAST = 'Hide toast';
const hideToast = (id) => (0, typesafe_actions_1.action)(exports.HIDE_TOAST, { id });
exports.hideToast = hideToast;
// Hide All Toasts
exports.HIDE_ALL_TOASTS = 'Hide all toasts';
const hideAllToasts = () => (0, typesafe_actions_1.action)(exports.HIDE_ALL_TOASTS);
