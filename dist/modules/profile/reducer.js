...
const profileReducer = (state = exports.INITIAL_STATE, action) => {
    switch (action.type) {
        ...
        case actions_1.LOAD_PROFILE_REQUEST: {
            return Object.assign(Object.assign({}, state), { loading: (0, reducer_1.loadingReducer)(state.loading, action), error: null });
        }
        ...
        case actions_1.SET_PROFILE_AVATAR_DESCRIPTION_SUCCESS: {
            ...
            const newAvatar = Object.assign(Object.assign({}, state.data[address].avatars[0]), { description,
                version });
            return Object.assign(Object.assign({}, state), { data: Object.assign(Object.assign({}, state.data), { [address]: Object.assign(Object.assign({}, state.data[address]), { avatars: [newAvatar, ...state.data[address].avatars.slice(1)] }) }), loading: (0, reducer_1.loadingReducer)(state.loading, action) });
        }
        case actions_1.LOAD_PROFILE_SUCCESS: {
            const { address, profile } = action.payload;
            return Object.assign(Object.assign({}, state), { data: Object.assign(Object.assign({}, state.data), { [address]: profile }), loading: (0, reducer_1.loadingReducer)(state.loading, action) });
        }
