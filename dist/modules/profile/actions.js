...
const loadProfileRequest = (address) => (0, typesafe_actions_1.action)(exports.LOAD_PROFILE_REQUEST, { address });
exports.loadProfileRequest = loadProfileRequest;
const loadProfileSuccess = (address, profile) => (0, typesafe_actions_1.action)(exports.LOAD_PROFILE_SUCCESS, { address, profile });
exports.loadProfileSuccess = loadProfileSuccess;
const loadProfileFailure = (address, error) => (0, typesafe_actions_1.action)(exports.LOAD_PROFILE_FAILURE, { address, error });
...
const setProfileAvatarDescriptionRequest = (address, description) => (0, typesafe_actions_1.action)(exports.SET_PROFILE_AVATAR_DESCRIPTION_REQUEST, { address, description });
exports.setProfileAvatarDescriptionRequest = setProfileAvatarDescriptionRequest;
const setProfileAvatarDescriptionSuccess = (address, description, version) => (0, typesafe_actions_1.action)(exports.SET_PROFILE_AVATAR_DESCRIPTION_SUCCESS, {
    address,
    description,
    version
});
exports.setProfileAvatarDescriptionSuccess = setProfileAvatarDescriptionSuccess;
const setProfileAvatarDescriptionFailure = (address, error) => (0, typesafe_actions_1.action)(exports.SET_PROFILE_AVATAR_DESCRIPTION_FAILURE, { address, error });
...
const clearProfileError = () => (0, typesafe_actions_1.action)(exports.CLEAR_PROFILE_ERROR);
exports.clearProfileError = clearProfileError;
// Change Profile
exports.CHANGE_PROFILE = 'Change Profile';
const changeProfile = (address, profile) => (0, typesafe_actions_1.action)(exports.CHANGE_PROFILE, { address, profile });
