...
function translationReducer(state = exports.INITIAL_STATE, action) {
    switch (action.type) {
        ...
        case actions_1.FETCH_TRANSLATIONS_REQUEST:
            return Object.assign(Object.assign({}, state), { loading: (0, reducer_1.loadingReducer)(state.loading, action), data: Object.assign(Object.assign({}, state.data), { [action.payload.locale]: null }) });
        case actions_1.FETCH_TRANSLATIONS_SUCCESS:
            return Object.assign(Object.assign({}, state), { loading: (0, reducer_1.loadingReducer)(state.loading, action), locale: action.payload.locale, data: Object.assign(Object.assign({}, state.data), { [action.payload.locale]: Object.assign({}, action.payload.translations) }) });
